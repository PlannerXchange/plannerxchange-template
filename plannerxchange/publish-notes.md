...
- app-data routes, methods, request bodies, type aliases, and spreads must remain statically resolvable; deliberately dynamic request contracts are builder findings, while `request_shape_resolution_unavailable` is a PlannerXchange processing failure
