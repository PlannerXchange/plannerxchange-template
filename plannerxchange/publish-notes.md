...
- wrappers are supported when review can statically trace local imports, parameter forwarding, assignments, and aliases from the user action to the matching runtime helper and declaration ID; direct calls remain the recommended simplest pattern
