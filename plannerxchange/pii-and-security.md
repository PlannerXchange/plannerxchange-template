...
- **Do not call shell-only import routes** - `/imports/*`, mapping, validation, execute, rollback, and import-job routes are PlannerXchange-owned; use `ctx.openDataImportSession({ declarationId })`
